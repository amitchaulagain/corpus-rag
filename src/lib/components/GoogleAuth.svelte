...
{:else}
  <div class="card bg-warning/20 border-2 border-warning shadow-xl">
    <div class="card-body text-center">
      <h2 class="card-title justify-center text-2xl text-warning-content mb-4">🔐 Authentication Required</h2>
      <p class="text-warning-content/80 mb-4">Please log in with your Google account to access the RAG system.</p>
      <p class="text-warning-content/60 text-sm mb-6">Your files will be stored securely in your own isolated folder.</p>
