...
1. resume (from context - your knowledge about the user)
2. job description

Your task is to perform a comprehensive job fit analysis, then create an optimized version of the resume tailored for this job. Return ONLY valid JSON - no explanations, no markdown code blocks, no extra text.
...
Step 7: OUTPUT THE OPTIMIZED RESUME
- Create an updated/optimized version of the resume from context that:
  * Adds missing skills where truthful and relevant
  * Incorporates missing keywords naturally
  * Rephrases bullet points to highlight relevant experience
  * Maintains all original truthful information
  * Only adds skills/keywords that can be reasonably inferred from existing experience
...
6. updated_resume must be complete, full resume text (not a summary or excerpt)
...
Your task: Enhance my resume to maximize fit for this specific job. Return ONLY the complete enhanced resume text—no scores, no analysis, no commentary.

Enhancement focus: {{enhancementFocus}}

Enhancement guidelines:
- ATS Optimization: Use keywords from the job description, ATS-friendly formatting
- Skills Matching: Highlight relevant technical and soft skills that match the job
- Keyword Enhancement: Use industry terminology and relevant buzzwords
- Experience Boost: Quantify achievements, use action verbs, emphasize impact
- General: Professional presentation and clarity

Output the enhanced resume text only. No markdown code blocks, no headers like "Enhanced Resume" or "Fit Score"—just the resume content.`
    ,
